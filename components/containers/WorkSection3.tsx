...
import chickSuperLegend3 from "@/public/images/chicken-superlegend3.png";

const WorkSection3 = () => {
  return (
    <section className="work work-alter">
        ...
        >
          ...
          >
            <Image
              ...
              style={{ width: "80%", height: "auto" }}
            />
            <h6>Super Legend Coco</h6>
            <p>
              This is crazy. I can't believe you got Super Legend Coco. This
              means your farm is already a huge hit
            </p>
          </div>
